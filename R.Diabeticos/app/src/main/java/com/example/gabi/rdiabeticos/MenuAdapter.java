...
public class MenuAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(datos.get(position) == "TARTAS"){ //Si es ActivityPerfil
            ...
            if(datos.get(position) =="BATIDOS"){//si es juego
                ...
                if(datos.get(position) =="BOLLERIA"){
