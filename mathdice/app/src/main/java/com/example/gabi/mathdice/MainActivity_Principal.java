...
public class MainActivity_Principal extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity__principal);
        /*
        ...
        task = new TimerTask() {
            ...
            public void run() {
                ...
                Intent mainIntent = new Intent().setClass(MainActivity_Principal.this, Main2Activity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_main_activity__principal, menu);
        return true;
    }
